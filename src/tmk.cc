...
uint8_t RgbColor::GetRed() const noexcept { return m_red; }

void RgbColor::SetRed(uint8_t red) noexcept { m_red = red; }

uint8_t RgbColor::GetGreen() const noexcept { return m_green; }

void RgbColor::SetGreen(uint8_t green) noexcept { m_green = green; }

uint8_t RgbColor::GetBlue() const noexcept { return m_blue; }

void RgbColor::SetBlue(uint8_t blue) noexcept { m_blue = blue; }
...
uint16_t Coordinate::GetColumn() const noexcept { return m_column; }

void Coordinate::SetColumn(uint16_t column) noexcept { m_column = column; }

uint16_t Coordinate::GetRow() const noexcept { return m_row; }

void Coordinate::SetRow(uint16_t row) noexcept { m_row = row; }
