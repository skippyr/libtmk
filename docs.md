...
int main(void)
{
    ...
    tdk_getWindowDimensions(&windowDimensions);
    tdk_writeLine(":: Total columns: %hu.", windowDimensions.totalColumns);
    tdk_writeLine(":: Total rows   : %hu.", windowDimensions.totalRows);
    return 0;
}
```
